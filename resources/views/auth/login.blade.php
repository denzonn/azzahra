...
<body class="bg-gray-100">
    <div class="h-screen relative">
        <div class="absolute bottom-1/2 right-0 translate-y-1/2 z-0">
            <img src="{{ asset('assets/img/backgroundlogin.png') }}" alt="" class="w-[50vw]">
        </div>
        <div class="grid grid-cols-2 h-screen space-x-0 gap-0 z-50">
            <div class="flex flex-col justify-center px-20">
                <div class="text-[52px] leading-none font-bold">
                    <div class="text-[80px] bg-primary text-white w-fit px-8 py-1 rounded-md tracking-widest">Azzahra</div><div class="tracking-tight">TRANSPORTAMA</div>
                </div>
